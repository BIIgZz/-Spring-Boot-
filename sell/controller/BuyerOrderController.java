...
import com.zzh.sell.converter.OrderForm2OrderDTOConverter;
 ...
 * @Author: zhuZHUzhu
 * @Description:
 * @Date: Created in 11:02 2020/3/16
 * @Modified By:
 */
@RestController
...
public class BuyerOrderController {
    ...
    //订单详情
    @GetMapping("/detail")
    public ResultVO<OrderDTO> detial(@RequestParam("openid") String openid,
